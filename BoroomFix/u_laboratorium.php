<?php 
  ...
  $queryRuangan = "SELECT * FROM ruang WHERE id_kategori = '3'";
        ...
        <table>
          ...
          <tbody>
            <?php 
              ...
              //siapkan query SQL
              $query = "SELECT * FROM ruang WHERE id_kategori = '3'";
              ...
              while ($data = mysqli_fetch_assoc($result)) { 
                ...
                echo "<td><img src='../BoroomFix/ruangan/" . $data['foto'] . "'alt='Foto Ruangan' width='100px'></td>";
